      ...
      <div className="container mx-auto px-4 md:px-6">
        <div className="flex flex-col md:flex-row items-center justify-between">
          ...
          <div className="flex flex-col sm:flex-row items-center space-y-4 sm:space-y-0 sm:space-x-8">
            ...
            <button 
              onClick={scrollToTop}
              className="rounded-full bg-qubica-blue/10 w-10 h-10 flex items-center justify-center text-qubica-blue hover:bg-qubica-blue/20 transition-colors mt-4 sm:mt-0"
            >
              <ArrowUp size={20} />
            </button>
          </div>
