...
const Contact = () => {
  ...
  return (
    <section id="contact" className="section-padding bg-black/30 relative">
      <div className="container mx-auto">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            <form onSubmit={handleSubmit}>
              <div className="mb-6">
                ...
                <input
                  ...
                  className="bg-qubica-charcoal border border-white/10 text-white rounded-lg block w-full p-3 focus:ring-qubica-blue focus:border-qubica-blue outline-none"
                  required
                />
              </div>
              <div className="mb-6">
              ...
              <div className="mb-6">
                ...
                <textarea
                  ...
                  onChange={handleChange}
                  className="bg-qubica-charcoal border border-white/10 text-white rounded-lg block w-full p-3 h-32 focus:ring-qubica-blue focus:border-qubica-blue outline-none"
                  required
                ></textarea>
              </div>
          ...
          <div className="flex flex-col space-y-8">
            ...
            <div className="gradient-card p-8">
              <h3 className="text-xl font-semibold mb-4">Agenda una llamada</h3>
