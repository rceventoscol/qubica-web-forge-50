...
const Contact = () => {
  ...
  return <section id="contact" className="section-padding bg-black/30 relative">
      <div className="container mx-auto">
        ...
        {/* Changed from grid to flex column and centered the single card */}
        <div className="flex flex-col items-center">
          <div className="gradient-card p-8 max-w-md w-full mx-auto">
            <h3 className="text-xl font-semibold mb-4 text-center">Contacto directo</h3>
