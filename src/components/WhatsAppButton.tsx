...
const WhatsAppButton = () => {
  ...
  return (
    <button
      ...
      className={`fixed bottom-6 right-6 z-50 bg-green-500 text-white rounded-full w-16 h-16 flex items-center justify-center shadow-lg transition-all duration-300 ${
        isVisible ? 'scale-100 opacity-100' : 'scale-0 opacity-0'
      }`}
    >
      <div className="absolute w-full h-full rounded-full animate-ping bg-green-500 opacity-75"></div>
